...
if asonscreen  
  ...
  set(zlimmodeauto,'zlimmode','manual')
  set(ztickmodeauto,'ztickmode','manual')
...
cmd = strrep(cmd,'<figurenumber>',figno.Number);
end    
...
if ~scalefonts
  ...
  case 'graphicx'   
   ...
   %          'cm]{' epsbasenameext '}%%\n' ]);
        fprintf(fid,['{\\includegraphics[width=\\figsize\\hsize]{' epsbasenameext '}}%%\n' ]);
  otherwise  
